...
List<ToolbarItem> defaultToolbarItems = [
  ...
  ToolbarItem(
    id: 'writely.toolbar.strikethrough',
    type: 2,
    group: baseToolbarIndex + 1,
    tooltipsMessage:
  ...
  ToolbarItem(
    id: 'writely.toolbar.bulleted_list',
    type: 3,
    group: baseToolbarIndex + 2,
